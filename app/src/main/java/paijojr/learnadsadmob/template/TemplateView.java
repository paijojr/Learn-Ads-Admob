...
package paijojr.learnadsadmob.template;
...
public class TemplateView extends FrameLayout {
    ...
    public void setStyles(NativeTemplate styles) {
        this.styles = styles;
        this.applyStyles();
    }
    ...
    public String getTemplateTypeName() {
        if (templateType == R.layout.native_medium_view) {
            return MEDIUM_TEMPLATE;
        } else if (templateType == R.layout.native_small_view) {
        ...
        try {
            templateType =
                    attributes.getResourceId(
                            R.styleable.TemplateView_gnt_template_type, R.layout.native_medium_view);
        } finally {
            attributes.recycle();
        }
